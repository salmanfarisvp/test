...
(() => {
  ...
  var init_src = __esm({
    "src/index.ts"() {
      ...
      import_colors = __require("kleur/colors");
      import_gzip_size = __require("gzip-size");
      import_brotli_size = __toESM(__require("brotli-size"), 1);
      import_pretty_bytes = __toESM(__require("pretty-bytes"), 1);
      import_fast_glob = __toESM(__require("fast-glob"), 1);
      import_fs = __require("fs");
      import_dts_bundle_generator = __require("dts-bundle-generator");
      import_status_message = __require("@jsheaven/status-message");
