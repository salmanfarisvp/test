...
export const getPadLeft = (str, width, char = " ") => char.repeat(width - str.length);
export const formatSize = (size, filename, type, raw) => {
...
export const getSizeInfo = async (code, filename, raw) => {
...
const printFileSizes = async (outfile) => {
...
export const genericDefaultBundleConifg = {
...
export const defaultBundleConfigBrowser = {
...
export const defaultBundleConfigNode = {
  ...genericDefaultBundleConifg,
  esBuildOptions: {
    ...baseConfig,
    platform: "node",
...
export const buildForBrowser = async (config) => genericBuild({
...
export const buildForNode = async (config) => genericBuild({
